    ...
    <div className="w-full bg-stone-50">
      ...
      <section className="py-24 px-6 max-w-3xl mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
         <img src={`${import.meta.env.BASE_URL}images/hero-potatoes.png`} alt="Potato Field" className="rounded-lg shadow-md hover:scale-[1.02] transition-transform h-full object-cover" />
